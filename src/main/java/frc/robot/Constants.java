...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double MAX_SPEED_METERS_PER_SECOND = 2 * Math.PI;
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(16.5);
    // Distance between centers of right and left wheels on robot
    public static final double WHEEL_BASE = Units.inchesToMeters(16.5);
